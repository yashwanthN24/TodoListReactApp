...
const HomePage = () => {
  ...
  return (
    <>
      <h1 className='bg-black text-white p-4 text-4xl font-bold text-center'>Yash's TODO List</h1>
      
      <form onSubmit={submitHandler}>
        <input type='text' className='text-2xl  border-zinc-800 border-4 px-4 py-2 m-8'
